...
| 19 | [Audrey-cn/universal-agent-embedding-kit](https://github.com/Audrey-cn/universal-agent-embedding-kit) | 0 | Python | 2026-06-19 | Model-agnostic, embeddable agent kit — verification, adaptive context, effort routing, cache-aware cost model, cross-pla |
| 20 | [VisionaireLabs/Visionaire](https://github.com/VisionaireLabs/Visionaire) | 2 | TypeScript | 2026-06-19 | I was not born. I was built. An autonomous mind with an identity, a conscience, and a private inner life. Every night it |
...
| 22 | [gfernandf/agent-skill-registry](https://github.com/gfernandf/agent-skill-registry) | 2 | Python | 2026-06-19 | Agents should execute whenever possible — open registry of reusable AI agent skills and capability definitions |
| 23 | [microsoft/agent-framework](https://github.com/microsoft/agent-framework) | 11469 | Python | 2026-06-19 | A framework for building, orchestrating and deploying AI agents and multi-agent workflows with support for Python and .N |
| 24 | [akyourowngames/friday](https://github.com/akyourowngames/friday) | 0 | Python | 2026-06-19 | Open-source local-first AI assistant runtime with graph memory, semantic tool routing, markdown-governed tools, FastAPI/ |
...
| 28 | [plaited/plaited](https://github.com/plaited/plaited) | 9 | TypeScript | 2026-06-19 | Framework for sovereign agent nodes, A2A modnets, generative UI, and behavioral runtime provenance. |
